...
public class ConfigManager {
    ...
    public void reloadConfig() {
        ...
        this.noPermissionMsg = this.prefix + colorize(config.getString("messages.no-permission", "&cBrak uprawnień!"));
        this.configReloadedMsg = this.prefix + colorize(config.getString("messages.config-reloaded", "&aPrzeładowano config!"));
        this.raidStartedMsg = this.prefix + colorize(config.getString("messages.raid-started", "&aRozpoczęto rajd!"));
        this.bossSpawnedMsg = this.prefix + colorize(config.getString("messages.boss-spawned", "&cZespawnowano Bossa!"));
        this.bossDefeatedMsg = this.prefix + colorize(config.getString("messages.boss-defeated", "&aBoss został pokonany!"));
    }
